...
* [Score Board](https://docs.google.com/spreadsheets/d/1HMSCgr-nVCXWSMN4p2LGBpA37_oNNgKhwXVlKn1BqTw)
- Judge Time:
    - 06/29: 2100
    - 06/30: 0000, 0300, 1200, 1800
    - 06/31: 0000(DEADLINE)
- Submission Way:
    - Go to the page for DSAP(Data Structure and Advanced Programming)
    - Enter the homework page and click the final project
    - Archive Snake.h and Snake.cpp and submit the archived file.
